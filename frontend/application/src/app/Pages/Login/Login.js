...
<div className="form-container"> 
  ...
  <form className="form">
    ...
    <button className="sign" onClick={login}>Entrar</button>
  </form>
  <div className="social-message">
    <div className="line"></div>
    <p className="message">Login com a conta Google</p>
    <div className="line"></div>
  </div>
